...
String.prototype.toJadenCase = function () {
  ...
  let jadenCasedWords = words.map(
    (word) => word.charAt(0).toUpperCase() + word.slice(1)
  );

  // Join the words back into a single string
  let jadenCasedString = jadenCasedWords.join(" ");

  return jadenCasedString;
};

let notJadenCasedString = "How can mirrors be real if our eyes aren't real";
let jadenCasedString = notJadenCasedString.toJadenCase();

console.log("Not Jaden-Cased:", notJadenCasedString);
console.log("Jaden-Cased:", jadenCasedString);
